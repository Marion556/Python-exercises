...
def print_upper_words(words, msw):
    # msw is a set containing the letters it must start with
    # if element[0] is in the set msw, then print element.
    for element in words:
        if element[0] in msw:
           print(element.upper())


print_upper_words(["hello", "hey", "goodbye", "yo", "yes"], msw={"h", "y"})